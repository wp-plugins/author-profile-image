<?php
/*
Plugin Name: Author Profile Image
Plugin URI: 
Description: Adds an author image uploader to the profile page.
Version: 1.0
Author: Anik Newaz
Author URI: https://profiles.wordpress.org/aniknewaz 
...
function get_easy_author_image($avatar, $id_or_email, $size, $default='', $alt='') {
        // if this plugin is activated, we'll assume the author wants to use their Author Profile Image instead of Gravatar.
